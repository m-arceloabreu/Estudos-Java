...
public class ControleClientePedido {
    ...
    public ClientePedido buscar (ClientePedido cp) throws SQLException, ClassNotFoundException {
        ...
        ClientePedido clientepedidosaida = cpDao.buscar(cp);
        cCli = new ControleCliente();
        cPed = new ControlePedido();

        Cliente cliEntrada = new Cliente(clientepedidosaida.getIdCli());
        Pedido pedEntrada = new Pedido(clientepedidosaida.getIdPed());
        Cliente cliSaida = cCli.buscar(cliEntrada);
        Pedido pedSaida = cPed.buscar(pedEntrada);
        clientepedidosaida.setCli(cliSaida);
        clientepedidosaida.setPed(pedSaida);
        
        return clientepedidosaida;
